...
const recursive = value => {
  ...
  if (value <= 20) {
    ...
    console.log(
      "Recursive function interrupted here as the values is greater or equal 20",
    );
  }
};
  ...
  try {
    ...
    for (let i = 1; i < numbers.length; i++) {
      if (
        ...
        throw new Error(
          "Invalid division: The elements must be numbers and the preceding element cannot be 0",
        );
      }
